...
public class RegularUserModelTest {
    ...
    void testRegularUserModelMapConstructor() {
        ...
        assertEquals("no profile picture", regularUser.getProfilePictureId());
    ...
    void testEqualsMethod() {
        ...
        RegularUserModel regularUser = new RegularUserModel(username, password, type, profilePicture, accountStatus, totalPoints, currentPoints, vipStatus);
        ...
        RegularUserModel regularUser2 = new RegularUserModel(username, password, type, profilePicture, accountStatus, totalPoints, currentPoints, vipStatus);
